            ...
            <div className={style.pagesWrapper}>
                <span className={style.logo}>Logo</span>
                {
                    ...
                    || authUser.role.name == roles.assistant || authUser.role.name == roles.receptionist
                        ? <NavLink className={path === '/dashboard' ? style.activePage : style.page} to={'/dashboard'}>
                            <img className={style.pageIcon} src={path === '/dashboard' ? DashboardLight : DashboardDark}
                                 alt=""/>
                            Dashboard</NavLink>
                        : null
                }
                {
                    authUser.role.name == roles.admin || authUser.role.name == roles.assistant || authUser.role.name == roles.receptionist
                        ? <NavLink className={path.includes('/stuff') ? style.activePage : style.page} to={'/stuff'}>
                            <img className={style.pageIcon} src={path.includes('/stuff') ? StuffLight : StuffDark} alt=""/>
                            Stuff</NavLink>
                        : null
                }
                {
                ...
                {
                    authUser.role.name == roles.admin
                        ? <NavLink className={path === '/sequence' ? style.activePage : style.page} to={'/sequence'}>
                            <img className={style.pageIcon} src={path === '/sequence' ? SequenceLight : SequenceDark}
                                 alt=""/>
                            Sequence</NavLink>
                        : null
                }
