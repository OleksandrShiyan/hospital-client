  ...
  return (
    <div className={style.stuffWrapper}>
      <div className={style.jobWrapper}>
        <NavLink
          className={path === '/stuff/doctors' ? style.currentJob : style.job}
          to="/stuff/doctors"
        >
          Doctors
        </NavLink>
        <NavLink
          className={path === '/stuff/assistants' ? style.currentJob : style.job}
          to="/stuff/assistants"
        >
          Assistants
        </NavLink>
        <NavLink
          className={path === '/stuff/receptionists' ? style.currentJob : style.job}
          to="/stuff/receptionists"
        >
          Receptionists
        </NavLink>
      </div>
