          ...
          render={({ handleSubmit }) => (
            <form className={style.createFormWrapper} onSubmit={handleSubmit}>
              <Field name="fullname">
                {({ input, meta }) => (
                  <div className={style.createFormNameWrapper}>
                    <span className={style.nameText}>Full Name: </span>
                    <input
                      {...input}
              ...
              <Field name="login">
                {({ input, meta }) => (
                  <div className={style.createFormNameWrapper}>
                    <span className={style.nameText}>Login: </span>
                    <input
                      {...input}
                      className={style.nameInput}
                      id="login"
              ...
              <Field name="password">
                {({ input, meta }) => (
                  <div className={style.createFormNameWrapper}>
                    <span className={style.nameText}>Password: </span>
                    <input
                      {...input}
                      className={style.nameInput}
                      id="password"
              ...
              <Field name="phone">
                {({ input, meta }) => (
                  <div className={style.createFormNameWrapper}>
                    <span className={style.nameText}>Phone: </span>
                    <input
                      {...input}
                      className={style.nameInput}
                      id="phone"
